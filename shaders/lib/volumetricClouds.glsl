...
#ifndef VOXY_PROGRAM
#if (defined BLOCKY_CLOUDS || defined PHOTON_CLOUDS) && defined OVERWORLD_SHADER
	#include "/lib/blockyClouds.glsl"
#endif
#if defined PHOTON_CLOUDS && defined OVERWORLD_SHADER
	#include "/lib/photonClouds.glsl"
#endif
...
vec4 GetVolumetricClouds(
	...
	#if defined PHOTON_CLOUDS && defined OVERWORLD_SHADER
		return GetPhotonClouds(viewPos, dither, sunVector, moonVector, directLightCol, directLightCol2, indirectLightCol, cloudPlaneDistance, cloudDistance);
	#elif defined BLOCKY_CLOUDS && defined OVERWORLD_SHADER
		return GetBlockyClouds(viewPos, dither, sunVector, moonVector, directLightCol, directLightCol2, indirectLightCol, cloudPlaneDistance, cloudDistance);
	#endif
